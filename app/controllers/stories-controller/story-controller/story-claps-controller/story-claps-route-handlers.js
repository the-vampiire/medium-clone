 ...
 * @param {Story} req.context.pathStory story belonging to this path
 ...
 * @param {Request} req Request object 
 * @param {Story} req.context.pathStory Story belonging to this path
 * @param {User} req.context.authedUser authenticated User clapping for the story
...
const clapForStoryHandler = async (req, res) => {
  const { context: { pathStory, authedUser }, body: { count } } = req;
